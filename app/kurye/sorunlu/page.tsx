...
import SorunluKargoGirisi from "@/components/SorunluKargoGirisi";
...
export default function SorunluKargoPage() {
    ...
    const loadUser = async () => {
      try {
        ...
        if (data.success && data.user) {
          ...
          // Sadece müşteri hizmetleri kullanıcısı sorunlu kargo girişi yapabilir
  ...
  return <SorunluKargoGirisi user={user} />;
}
